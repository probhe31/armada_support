	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			to social media apps and services that are already on your device. These
			 images do not identify you the user, and are the same for all users. 
			However, sharing the image (and any commentary that you supply) will 
			...
			registration for the AR functionality. No images from the video camera 
