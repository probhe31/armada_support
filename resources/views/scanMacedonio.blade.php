             ...
             <!-- Section-header -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h3 class="subtitle_section">DISCOVER THE TALENT AND PASSIONS OF A GREAT PERUVIAN ARTIST.</h3>
                        <div class="image_container"><img src="{{URL::asset('img/track6.png')}}" alt="Avatar" class="pb-image-pj" width="250px"></div>


                        </div>


                        <p class="contact-us">** For a full experience, scan this label from the side menu option "SCAN FROM WEB" in the Pisco Macedonio App.</p>
                        <br>
                        <p class="contact-us">Please contact us at:</p>
                        <p class="contact-us"><a class="link" href="mailto:soporte.bodega.ras@gmail.com">soporte.bodega.ras@gmail.com</a></p>
